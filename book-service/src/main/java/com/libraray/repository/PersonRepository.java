...
//    @Modifying
//    @Transactional
//    @Query("UPDATE #{#entityName} e SET e.contactDetails = :newContactDetails  WHERE e.id = :id")
//    void updateContactDetails(@Param("id") Long id, @Param("newContactDetails") ContactDetails contactDetails);
